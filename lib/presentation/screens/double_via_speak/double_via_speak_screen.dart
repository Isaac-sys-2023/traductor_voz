...
//   // Controladores de edición para cada mensaje
//   final Map<int, TextEditingController> _editControllers = {};
//   final Map<int, TextEditingController> _editTranslatedControllers = {};
...
//       _editTranslatedControllers.clear();
//       _isEditingMap.clear();
//     });
//     _flutterTts.stop();
//   }
...
//                   // Limpiar controladores si existen
//                   if (_editControllers.containsKey(index)) {
//                     _editControllers[index]!.dispose();
//                     _editControllers.remove(index);
//                   }
//                   if (_editTranslatedControllers.containsKey(index)) {
//                     _editTranslatedControllers[index]!.dispose();
//                     _editTranslatedControllers.remove(index);
//                   }
//                   _isEditingMap.remove(index);
//                 });
//                 Navigator.of(context).pop(); // Cerrar diálogo
//               },
//               child: const Text('Sí'),
...
//     setState(() {
//       _isEditingMap[index] = true;
      
//       // Inicializar controladores si no existen
//       if (!_editControllers.containsKey(index)) {
//         _editControllers[index] = TextEditingController(
//           text: _conversationHistory[index].originalText
//         );
//       }
      
//       if (!_editTranslatedControllers.containsKey(index)) {
//         _editTranslatedControllers[index] = TextEditingController(
//           text: _conversationHistory[index].translatedText
//         );
//       }
//     });
//   }
...
//     setState(() {
//       _isEditingMap[index] = false;
//     });
//   }

//   // Función para guardar los cambios de un mensaje editado
//   Future<void> _saveEditedMessage(int index) async {
//     final isConnected = context.read<ConnectivityProvider>().isConnected;
    
//     if (!isConnected) {
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text('No hay conexión a internet. No se puede editar.'))
//       );
//       return;
//     }

//     final originalText = _editControllers[index]!.text;
//     final translatedText = _editTranslatedControllers[index]!.text;
...
//     setState(() {
//       _isEditingMap[index] = false;
//       _conversationHistory[index].originalText = originalText;
//       _conversationHistory[index].translatedText = translatedText;
//     });

//     // Retraducir el mensaje si es necesario
//     try {
//       final translator = GoogleTranslator();
//       final message = _conversationHistory[index];
      
//       var newTranslation = await translator.translate(
//         originalText,
//         from: message.originalLanguage,
//         to: message.translatedLanguage,
//       );
      
//       setState(() {
//         _conversationHistory[index].translatedText = newTranslation.text;
//         if (_editTranslatedControllers.containsKey(index)) {
//           _editTranslatedControllers[index]!.text = newTranslation.text;
//         }
//       });
//     } catch (e) {
//       print('Error al retraducir: $e');
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text('Error al retraducir el mensaje'))
//       );
//     }
//   }
...
//     // Dispose de todos los controladores de edición
//     _editControllers.forEach((key, controller) => controller.dispose());
//     _editTranslatedControllers.forEach((key, controller) => controller.dispose());
...
//                   itemCount: _conversationHistory.length,
//                   itemBuilder: (context, index) {
//                     // Convertir índice invertido a índice real
//                     final realIndex = _conversationHistory.length - 1 - index;
//                     final message = _conversationHistory[realIndex];
//                     final isUserA = message.speaker == 'A';
//                     final isEditing = _isEditingMap[realIndex] ?? false;
...
//                                                   onPressed: () => _saveEditedMessage(realIndex),
//                                                   tooltip: 'Guardar cambios',
//                                                 ),
//                                                 IconButton(
//                                                   icon: const Icon(Icons.close, size: 18, color: Colors.red),
//                                                   onPressed: () => _cancelEditing(realIndex),
...
//                                       if (isEditing)
//                                         TextField(
//                                           controller: _editControllers[realIndex],
//                                           maxLines: null,
//                                           decoration: const InputDecoration(
//                                             border: OutlineInputBorder(),
//                                           ),
...
//                                             if (isEditing)
//                                               TextField(
//                                                 controller: _editTranslatedControllers[realIndex],
//                                                 maxLines: null,
//                                                 decoration: const InputDecoration(
//                                                   border: OutlineInputBorder(),
//                                                 ),
//                                                 enabled: false, // No se puede editar directamente
//                                               ),
//                                           ],
//                                         ),
//                                       ),
