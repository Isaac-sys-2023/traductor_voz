...
class _DoubleViaSpeakScreenState extends State<DoubleViaSpeakScreen> {
  ...
  Future<void> _saveEditedMessage(int index) async {
    ...
    if (!isConnected) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('No hay conexión a internet. No se puede editar.'),
        ),
      );
      return;
    }
    ...
    try {
      ...
      setState(() {
        ...
        _conversationHistory[index] = ConversationMessage(
          speaker: message.speaker,
          originalText: originalText,
          translatedText: newTranslation.text,
  ...
  void dispose() {
    ...
    _editTranslatedControllers.forEach(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            if (isEditing)
                                              TextField(
                                                controller:
                                                    _editTranslatedControllers[realIndex],
                                                maxLines: null,
                                                decoration:
                                                ...
                                                enabled:
                                                    false, // No se puede editar directamente
                                              ),
                                          ],
                                        ),
                                      ),
